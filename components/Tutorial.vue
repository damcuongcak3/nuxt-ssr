...
<template>
  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-2 flex justify-center align-items-center">
        <nuxt-link to="/" class="mr-2 text-primary">Index</nuxt-link>

        <nuxt-link to="/about" class="mr-2 text-primary">About</nuxt-link>
      </div>
    </div>
  </div>
</template>
